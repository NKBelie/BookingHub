    ...
    return (
        ...
        <div className="border-b border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div key={title} className="flex items-center gap-3 bg-white rounded-lg border border-border p-4">
                    <img src={img} alt={title} className="w-16 h-16 object-contain shrink-0" loading="lazy" />
                    <div>
