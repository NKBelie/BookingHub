...
export default function LoginPage() {
    ...
    return (
        ...
        <div className="bg-white rounded-lg border border-border shadow-sm w-full max-w-sm p-8">
            ...
            <p className="text-sm text-muted mb-6">Access your bookings, saved properties, and more.</p>
            ...
            <div className="relative flex justify-center">
                <span className="bg-white px-3 text-xs text-muted">or continue with</span>
            </div>
            </div>

            <button className="w-full flex items-center justify-center gap-2 border border-border rounded-md py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
