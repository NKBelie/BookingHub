...
export default function PropertyTypeTabs({ activeType, onSelect }) {
  return (
          ...
          {tabs.map(({ type, label, icon }) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3.5 text-sm font-medium border-b-2 whitespace-nowrap transition-colors duration-150 ${
                  active
